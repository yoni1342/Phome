import { View, Text, SafeAreaView, ScrollView, Slider,Switch,TouchableOpacity } from "react-native";
import images from "../../../assets/imageassets";
import Icon from "react-native-vector-icons/Ionicons";
// import {Slider} from 'react-native-co'
...
const Index = ({navigation,lightStatus,lightBrightness,turnOff, turnOn,setBrightness}) => {
          ...
          <View className="flex px-3">
            ...
            <View className="flex flex-row items-center justify-between px-10">
              <View className="flex flex-row items-center ">
                <Text className="text-[100rem] font-extralight">{Math.round(lightBrightness)}</Text>
                <Icon
